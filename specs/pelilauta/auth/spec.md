...
> See also: [`../auth-package/spec.md`](../auth-package/spec.md) for the `@pelilauta/auth` package shell, sub-exports, and the extracted file paths (`packages/auth/src/components/AuthHandler.svelte`, `packages/auth/src/components/AuthChrome.svelte`).
