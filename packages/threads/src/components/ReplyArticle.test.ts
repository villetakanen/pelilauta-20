...
// Verifies: specs/pelilauta/threads/detail-page/replies/spec.md §ReplyArticle composes its DS primitives without async work
// Verifies: specs/pelilauta/threads/detail-page/replies/spec.md §ReplyArticle uses the reply variant of CnBubble when fromUser is true
