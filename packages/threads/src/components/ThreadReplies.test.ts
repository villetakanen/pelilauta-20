...
// Verifies: specs/pelilauta/threads/replies/spec.md §ThreadReplies SSR-renders every initialReply with id={reply.key}
// Verifies: specs/pelilauta/threads/replies/spec.md §ThreadReplies mounts the realtime listener only when authenticated
// Verifies: specs/pelilauta/threads/replies/spec.md §ThreadReplies merges a docChanges diff into the rendered list
// Verifies: specs/pelilauta/threads/replies/spec.md §ThreadReplies scrolls to the first reply at-or-after targetFlowTime
// Verifies: specs/pelilauta/threads/replies/spec.md §ThreadReplies does not scroll when no reply matches targetFlowTime
// Verifies: specs/pelilauta/threads/replies/spec.md §Anonymous SSR response is uid-independent and listener-free
// Verifies: specs/pelilauta/threads/replies/spec.md §Authenticated SSR resolves fromUser from currentUid
// Verifies: specs/pelilauta/threads/replies/spec.md §ThreadReplies recomputes fromUser when the auth atom resolves
// Verifies: specs/pelilauta/threads/replies/spec.md §Native #reply-{key} fragment scrolls without component logic
